...
const Login = () => {
  ...
  const handleLoginSubmit = async (e) => {
    ...
    // Fake user data (thay thế API call)
    const mockUser = {
    ...
    if (
      ...
      context.triggerAuthCheck(); // Giả lập kiểm tra xác thực
      ...
      <div className="login__form">
        <div className="container mx-auto p-4 flex justify-center min-h-[600px] items-center">
          ...
          >
            ...
            {errorMessage && <Toast type="error" message={errorMessage} dismissError={dismissError} />}
            <div className="items-center">
              ...
              <div className="flex flex-wrap justify-center my-3 w-full">
                <Link to="/forgot-password" className="inline-block text-md text-gray-500 hover:text-blue-800">
              ...
              <div className="relative mt-5">
                <div className="absolute left-0 right-0 flex justify-center items-center">
                  ...
                  <span className="bg-white px-3 text-gray-500 z-10">New to Stay Booker?</span>
                </div>
              </div>
              <div className="flex flex-wrap justify-center my-3 w-full mt-12">
                <Link to="/register" className="inline-block font-medium text-md text-brand hover:text-blue-800">
                  Create an account
                </Link>
              </div>
            </div>
